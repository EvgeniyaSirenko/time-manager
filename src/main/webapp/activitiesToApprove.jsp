				...
				<table id="activities_table">
					<thead>
						<tr>
							<td>№</td>
							<td><fmt:message
									key="activities_to_approve_jsp.label.participant_login" /></td>
							<td><fmt:message
									key="activities_to_approve_jsp.label.activity" /></td>
							<td><fmt:message
									key="activities_to_approve_jsp.label.reaction" /></td>
							<td><fmt:message
									key="activities_to_approve_jsp.label.reaction" /></td>
						</tr>
					</thead>
							...
							<td>
								<form action="controller" method="post">
									...
									<input type=hidden name="activityName"
										...
										type="submit"
										value="<fmt:message key="admin_jsp.button.approve_activity"/>" />
								</form>
							</td>
							...
							<td>
								<form action="controller" method="post">
									<input type="hidden" name="command"
										value="rejectApproveActivity" /> <input type=hidden
